...
Supabase Auth (self-hosted, HS256 JWT), Stripe, NVIDIA NIM (Kimi K2.5 + FLUX.1)
...
- Redis
- Supabase (self-hosted — already configured at `https://api.zaidan-group.com`)
...
| auth.spec.ts — wrong password | Update needed | Now uses email/password via Supabase Auth |
